...
class MxCost {
	 ...
	 * that is easier to work with. dims[] stores the dimensions of matrices. dim[0] is the number of rows of the 1st matrix, dim[1] is the number of columns of the 1st matrix. 
